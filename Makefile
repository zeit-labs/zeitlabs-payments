...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd zeitlabs_payments && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd zeitlabs_payments && i18n_tool generate

detect_changed_source_translations:
	cd zeitlabs_payments && i18n_tool changed
...
pull_translations:
	find zeitlabs_payments/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/zeitlabs-payments/zeitlabs_payments/conf/locale:zeitlabs_payments/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd zeitlabs_payments && i18n_tool dummy
