...
"""
futurex-ecommerce documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'futurex-ecommerce',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/zeit-labs/futurex-ecommerce",
...
#
# html_title = 'futurex-ecommerce v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Simple ecommerce solution for Open edX to process payments of paid courses.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'futurex_ecommerce'),
                os.path.join(root_path, 'futurex_ecommerce/migrations')])
