...
from zeitlabs_payments.providers.payfort.exceptions import (
    PayFortException,
    PayFortBadSignatureException,
)
from zeitlabs_payments.models import Cart, CatalogueItem, CartItem
...
@pytest.mark.django_db
def test_get_order_description_multiple_items(base_data: Any) -> None:
    """
