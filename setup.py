#!/usr/bin/env python
"""
Package metadata for futurex_ecommerce.
"""
import os
import re
import sys
...
VERSION = get_version('futurex_ecommerce', '__init__.py')
...
setup(
    name='futurex-ecommerce',
    version=VERSION,
    description="""Simple ecommerce solution for Open edX to process payments of paid courses.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Zeit labs project',
    author_email='oscm@openedx.org',
    url='https://github.com/zeit-labs/futurex-ecommerce',
    packages=find_packages(
        include=['futurex_ecommerce', 'futurex_ecommerce.*'],
        exclude=["*tests"],
    ),
